...
const features = [
  {
    ...
    description: "Provide liquidity within a custom price range for deeper capital efficiency and higher fee yield than a full-range pool.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Instant Swaps",
    description: "Trade any listed pair with tight spreads and sub-5-second finality, settled directly on Stellar Soroban.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Real-time Portfolio",
    description: "Track your open positions, fees earned, and price ranges across every pool from a single dashboard.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Non-Custodial Security",
    description: "Your keys, your funds. Every trade and liquidity position is enforced by audited Soroban smart contracts.",
    visual: "security",
  },
];
  ...
  return (
    <svg viewBox="0 0 200 160" className="w-full h-full">
      ...
      {[0, 1, 2, 3, 4, 5].map((i) => {
        ...
        const radius = 50;
        // Rounded to avoid SSR/client hydration mismatches from
        // platform-specific last-bit differences in Math.cos/sin.
